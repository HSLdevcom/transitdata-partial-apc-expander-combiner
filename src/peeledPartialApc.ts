/**
 * Generated manually with https://app.quicktype.io/ on 2022-08-30 using an
 * anonymized incorrect JSON from the vendor system. Functions u
 * and m were also removed by hand as unused.
 */

// To parse this data:
//
//   import { Convert, PeeledPartialApc } from "./file";
//
//   const peeledPartialApc = Convert.toPeeledPartialApc(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface PeeledPartialApc {
  tst: Date;
  lat: number;
  long: number;
...
export class Convert {
  public static toPeeledPartialApc(json: string): PeeledPartialApc {
    return cast(JSON.parse(json), r("PeeledPartialApc"));
  }

  public static peeledPartialApcToJson(value: PeeledPartialApc): string {
    return JSON.stringify(uncast(value, r("PeeledPartialApc")), null, 2);
  }
}
